import{hG as m,hH as P,hI as y,ht as g,hJ as $,r as _,hK as O,hL as u,hM as S,hN as A,hO as x,hP as C,al as o,hQ as v,hR as E,hS as h,hT as w,ai as F,hU as b,R as T,ac as n,hV as l,hW as d,hX as N,hY as D,hZ as M,h_ as R,h$ as I,i0 as L,i1 as U,i2 as W,i3 as G,i4 as B,i5 as H,i6 as z,i7 as j,i8 as Q,i9 as V,ia as q,ib as J,am as c,ic as K,id as X,ie as Y,ig as Z}from"./index-70f3b4f7.js";function k(a){const e=new m,{vertex:t,fragment:s}=e;return P(t,a),e.include(y,a),e.attributes.add(g.POSITION,"vec3"),e.attributes.add(g.UV0,"vec2"),e.varyings.add("vpos","vec3"),a.hasMultipassTerrain&&e.varyings.add("depth","float"),t.uniforms.add(new $("textureCoordinateScaleFactor",r=>_(r.texture)&&_(r.texture.descriptor.textureCoordinateScaleFactor)?r.texture.descriptor.textureCoordinateScaleFactor:O)),t.code.add(u`
    void main(void) {
      vpos = position;
