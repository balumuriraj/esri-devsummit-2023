import{r as g}from"./typedArrayUtil-4d7bb04c.js";import{r as s}from"./vec2-528adfe4.js";import{n as S}from"./vec2f64-30dc1443.js";import{l as h}from"./vec4f64-e407da96.js";import{u}from"./Slice.glsl-3b39b1f7.js";import{c as v,u as m,b as x}from"./HUD.glsl-d3a072ad.js";import{i as b}from"./VerticalOffset.glsl-87cbb2e3.js";import{e as l}from"./Texture2DPassUniform-753de459.js";import{e as d}from"./Float4PassUniform-d7bdbc81.js";import{o as c}from"./FloatPassUniform-68d54f51.js";import{o as z,n as r}from"./ShaderBuilder-a7d0da4e.js";import{O as w}from"./VertexAttribute-9c5c630d.js";function A(e){const t=new z;t.include(v),t.include(m,e),t.include(u,e),t.attributes.add(w.UV0,"vec2");const{vertex:n,fragment:a}=t;return n.uniforms.add([new d("viewport",(i,o)=>o.camera.fullViewport),new c("lineSize",(i,o)=>Math.ceil(i.size)*o.camera.pixelRatio),new l("pixelToNDC",(i,o)=>s(f,2/o.camera.fullViewport[2],2/o.camera.fullViewport[3])),new c("borderSize",(i,o)=>g(i.borderColor)?o.camera.pixelRatio:0),new l("screenOffset",(i,o)=>s(f,i.screenOffset[0]*o.camera.pixelRatio,i.screenOffset[1]*o.camera.pixelRatio))]),t.varyings.add("coverageSampling","vec4"),t.varyings.add("lineSizes","vec2"),e.hasMultipassGeometry&&t.varyings.add("depth","float"),e.hasScreenSizePerspective&&b(n),n.code.add(r`
    void main(void) {
